<template>
    ...
    <section class="reportedsnippets" >
      <div class="modelPlace" v-if="modelBestFromHeader">
        <div class="card" v-for="codeSnippet in modelBestFromHeader.allContent" :key="codeSnippet.id">
